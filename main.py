...
if __name__ == '__main__':
    ...
    # это лишь псевдо-тест, потом туде надо будет пихать массив массивов
    # вопросы по порядку, где в каждом массиве 0 элемент - вопрос, остальные - ответы
